...
RSpec.describe "Api::V1::Locations", type: :request do
  before do
    ...
    allow(aws_result).to receive(:results).and_return(
      [
        Aws::LocationService::Types::SearchForSuggestionsResult.new(text: '78681, Round Rock, TX, USA', place_id: 'random_id1'),
        Aws::LocationService::Types::SearchForSuggestionsResult.new(text: '78681, Villa de Ramos, San Luis Potosí, MEX', place_id: 'random_id2')
      ]
    )
